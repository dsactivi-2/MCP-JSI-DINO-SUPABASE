...
EXPECTED_QUERY_IDS = ["SQL-GATE-B3-001","SQL-GATE-B3-002","SQL-GATE-B3-003","SQL-GATE-B3-004","SQL-GATE-B3-005","SQL-GATE-B3-006","SQL-GATE-B3-007","SQL-GATE-B3-008","SQL-GATE-B3-009","SQL-GATE-B3-011","SQL-GATE-B3-010"]
FINDING_QUERY_IDS: set[str] = set()
PER_QUERY_LIMIT = 4 * 1024 * 1024
...
def main() -> int:
    args = parse_args()
    expected_database = os.environ.pop("GATE_B3_EXPECTED_DATABASE_NAME", "")
    if not expected_database:
        print("STOP: expected database value missing", file=sys.stderr)
        return 1

    boundary_token = uuid.uuid4().hex
    boundary_prefix = f"__GATE_B3_BOUNDARY__|{boundary_token}|".encode("ascii")

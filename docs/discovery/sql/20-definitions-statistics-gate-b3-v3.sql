-- GATE B3 V3. Discovery role. Raw stays outside Git.
...
\echo __GATE_B3_BOUNDARY__|:boundary_token|BEGIN|SQL-GATE-B3-001
SELECT
...
LIMIT 5001;
\echo __GATE_B3_BOUNDARY__|:boundary_token|END|SQL-GATE-B3-001
...
\echo __GATE_B3_BOUNDARY__|:boundary_token|BEGIN|SQL-GATE-B3-002
SELECT
...
LIMIT 5001;
\echo __GATE_B3_BOUNDARY__|:boundary_token|END|SQL-GATE-B3-002
...
\echo __GATE_B3_BOUNDARY__|:boundary_token|BEGIN|SQL-GATE-B3-003
SELECT
...
LIMIT 5001;
\echo __GATE_B3_BOUNDARY__|:boundary_token|END|SQL-GATE-B3-003
...
\echo __GATE_B3_BOUNDARY__|:boundary_token|BEGIN|SQL-GATE-B3-004
SELECT
...
LIMIT 5001;
\echo __GATE_B3_BOUNDARY__|:boundary_token|END|SQL-GATE-B3-004


-- SQL-GATE-B3-005
-- SENSITIVITY: enum labels can expose controlled internal vocabulary, status
-- values, workflow states, and taxonomy details.
\echo __GATE_B3_BOUNDARY__|:boundary_token|BEGIN|SQL-GATE-B3-005
SELECT
...
LIMIT 5001;
\echo __GATE_B3_BOUNDARY__|:boundary_token|END|SQL-GATE-B3-005
...
\echo __GATE_B3_BOUNDARY__|:boundary_token|BEGIN|SQL-GATE-B3-006
SELECT
...
LIMIT 5001;
\echo __GATE_B3_BOUNDARY__|:boundary_token|END|SQL-GATE-B3-006
...
\echo __GATE_B3_BOUNDARY__|:boundary_token|BEGIN|SQL-GATE-B3-007
SELECT
...
LIMIT 5001;
\echo __GATE_B3_BOUNDARY__|:boundary_token|END|SQL-GATE-B3-007
...
\echo __GATE_B3_BOUNDARY__|:boundary_token|BEGIN|SQL-GATE-B3-008
SELECT
...
LIMIT 5001;
\echo __GATE_B3_BOUNDARY__|:boundary_token|END|SQL-GATE-B3-008


-- SQL-GATE-B3-009
-- SENSITIVITY: policy role names expose authorization structure even without
-- policy expressions or row data.
\echo __GATE_B3_BOUNDARY__|:boundary_token|BEGIN|SQL-GATE-B3-009
SELECT
...
LIMIT 5001;
\echo __GATE_B3_BOUNDARY__|:boundary_token|END|SQL-GATE-B3-009
...
\echo __GATE_B3_BOUNDARY__|:boundary_token|BEGIN|SQL-GATE-B3-011
SELECT
...
LIMIT 5001;
\echo __GATE_B3_BOUNDARY__|:boundary_token|END|SQL-GATE-B3-011


-- SQL-GATE-B3-010: confirm stable identity and guardrails before rollback
\echo __GATE_B3_BOUNDARY__|:boundary_token|BEGIN|SQL-GATE-B3-010
SELECT
...
\echo __GATE_B3_BOUNDARY__|:boundary_token|END|SQL-GATE-B3-010

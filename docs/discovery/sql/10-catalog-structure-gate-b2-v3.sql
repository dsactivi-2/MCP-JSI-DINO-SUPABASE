-- GATE B2 V3. Discovery role dino_crm_discovery_ro_v1.
-- Prerequisite: Gate B1 V3 RO PASS. Stream markers required.
...
\echo __GATE_B2_BOUNDARY__|:boundary_token|BEGIN|SQL-GATE-B2-001
SELECT
...
LIMIT 5001;
\echo __GATE_B2_BOUNDARY__|:boundary_token|END|SQL-GATE-B2-001


-- SQL-GATE-B2-002: relations, structural flags, size classes, and row estimates
\echo __GATE_B2_BOUNDARY__|:boundary_token|BEGIN|SQL-GATE-B2-002
SELECT
...
LIMIT 5001;
\echo __GATE_B2_BOUNDARY__|:boundary_token|END|SQL-GATE-B2-002


-- SQL-GATE-B2-003: columns and structural type flags
\echo __GATE_B2_BOUNDARY__|:boundary_token|BEGIN|SQL-GATE-B2-003
SELECT
...
LIMIT 5001;
\echo __GATE_B2_BOUNDARY__|:boundary_token|END|SQL-GATE-B2-003


-- SQL-GATE-B2-004: constraints and relationship identifiers without definitions
\echo __GATE_B2_BOUNDARY__|:boundary_token|BEGIN|SQL-GATE-B2-004
SELECT
...
LIMIT 5001;
\echo __GATE_B2_BOUNDARY__|:boundary_token|END|SQL-GATE-B2-004


-- SQL-GATE-B2-005: RLS table flags without policy expressions
\echo __GATE_B2_BOUNDARY__|:boundary_token|BEGIN|SQL-GATE-B2-005
SELECT
...
ORDER BY schema_name, relation_name
LIMIT 5001;
\echo __GATE_B2_BOUNDARY__|:boundary_token|END|SQL-GATE-B2-005


-- Empty results do not prove absence of grants to other roles.
-- SQL-GATE-B2-006: explicit table and view grant names and flags
\echo __GATE_B2_BOUNDARY__|:boundary_token|BEGIN|SQL-GATE-B2-006
SELECT
...
LIMIT 5001;
\echo __GATE_B2_BOUNDARY__|:boundary_token|END|SQL-GATE-B2-006


-- SQL-GATE-B2-007: routine signatures and security flags without source bodies
\echo __GATE_B2_BOUNDARY__|:boundary_token|BEGIN|SQL-GATE-B2-007
SELECT
...
LIMIT 5001;
\echo __GATE_B2_BOUNDARY__|:boundary_token|END|SQL-GATE-B2-007
...
\echo __GATE_B2_BOUNDARY__|:boundary_token|BEGIN|SQL-GATE-B2-008
SELECT
...
LIMIT 5001;
\echo __GATE_B2_BOUNDARY__|:boundary_token|END|SQL-GATE-B2-008


-- SQL-GATE-B2-009: index names, state flags, and size classes
\echo __GATE_B2_BOUNDARY__|:boundary_token|BEGIN|SQL-GATE-B2-009
SELECT
...
LIMIT 5001;
\echo __GATE_B2_BOUNDARY__|:boundary_token|END|SQL-GATE-B2-009


-- SQL-GATE-B2-010: trigger names and flags without trigger definitions
\echo __GATE_B2_BOUNDARY__|:boundary_token|BEGIN|SQL-GATE-B2-010
SELECT
...
LIMIT 5001;
\echo __GATE_B2_BOUNDARY__|:boundary_token|END|SQL-GATE-B2-010


-- SQL-GATE-B2-011: extension names and versions without configuration
\echo __GATE_B2_BOUNDARY__|:boundary_token|BEGIN|SQL-GATE-B2-011
SELECT
...
LIMIT 5001;
\echo __GATE_B2_BOUNDARY__|:boundary_token|END|SQL-GATE-B2-011


-- SQL-GATE-B2-012: publication names and structural flags
\echo __GATE_B2_BOUNDARY__|:boundary_token|BEGIN|SQL-GATE-B2-012
SELECT
...
LIMIT 5001;
\echo __GATE_B2_BOUNDARY__|:boundary_token|END|SQL-GATE-B2-012


-- SQL-GATE-B2-013: publication membership names
\echo __GATE_B2_BOUNDARY__|:boundary_token|BEGIN|SQL-GATE-B2-013
SELECT
...
LIMIT 5001;
\echo __GATE_B2_BOUNDARY__|:boundary_token|END|SQL-GATE-B2-013


-- SQL-GATE-B2-014: confirm stable identity and guardrails before rollback
\echo __GATE_B2_BOUNDARY__|:boundary_token|BEGIN|SQL-GATE-B2-014
SELECT
...
\echo __GATE_B2_BOUNDARY__|:boundary_token|END|SQL-GATE-B2-014

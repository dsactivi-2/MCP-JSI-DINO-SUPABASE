...
| F-05 | Q4 ERSETZT die alte R1-Kontaktfreiheit: interne Vermittler sehen Kontakte; Kunde erst nach Einstellungsfreigabe. Discovery speichert keine Kontaktwerte. | [ADR-0002](../decisions/0002-search-design-interview.md) Q4 | Produkt intern mit Kontakt; Artefakte ohne Dump. |
...
| F-PHP | PHP-Hauptsuche, Filter-SQL, B7-Klicks und C 4–9 sind als Codebefund dokumentiert. Wizard-03-Alltag bestätigt (R1 = Hauptsuche). JSON-Filter ist Entwurf. | [Inventar](crm-work-inventory.md) | Nächster Schritt: Entwurf prüfen, nicht MCP-Bau. |
